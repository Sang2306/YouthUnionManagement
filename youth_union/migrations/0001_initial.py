# Generated by Django 2.2.1 on 2020-08-01 07:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checked_activities', models.ManyToManyField(editable=False, related_name='was_checked_by', to='youth_union.Activity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(help_text='Ai là nguời đăng thông báo?', on_delete=django.db.models.deletion.CASCADE, to='youth_union.User')),
            ],
            options={
